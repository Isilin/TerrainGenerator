    ...
    Water: folder(
      {
        ...
        waterWaveSpeed: {
          value: urlDisplayState?.waterWaveSpeed ?? persistedState.waterWaveSpeed,
          min: 0,
          max: 4,
          step: 0.01,
        },
        waterWaveAmplitude: {
          value: urlDisplayState?.waterWaveAmplitude ?? persistedState.waterWaveAmplitude,
          min: 0,
          max: 3,
          step: 0.01,
        },
        waterWaveFrequency: {
          value: urlDisplayState?.waterWaveFrequency ?? persistedState.waterWaveFrequency,
          min: 0.01,
          max: 0.4,
          step: 0.001,
        },
